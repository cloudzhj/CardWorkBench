...
namespace CardWorkbench.Controls
{
    public class Frame 
    {
        ...
        public Frame(int frameID, string pcm1, string pcm2, string pcm3, string pcm4, string pcm5, string pcm6, string pcm7, string pcm8, string pcm9, string pcm10, string pcm11, string pcm12)
        {
            this.Number = frameID;
            this.SyncWord = "ABBC";
            this.Word1 = pcm1;
